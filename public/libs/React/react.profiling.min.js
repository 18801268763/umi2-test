...
function Ra(a,b,c){var d=a.result,e=a.keyPrefix;a=a.func.call(a.context,b,a.count++);Array.isArray(a)?ba(a,d,c,function(a){return a}):null!=a&&(X(a)&&(a=Na(a,e+(!a.key||b&&b.key===a.key?"":(""+a.key).replace(za,"$&/")+"/")+c)),d.push(a))}function ba(a,b,c,d,e){var h="";null!=c&&(h=(""+c).replace(za,"$&/")+"/");b=wa(b,h,d,e);aa(a,Ra,b);xa(b)}function y(){var a=Aa.current;if(null===a)throw Error(x(321));return a}function ca(a,b){var c=a.length;a.push(b);for(;;){var d=c-1>>>1,e=a[d];if(void 0!==e&&
0<M(e,b))a[d]=b,a[c]=e,c=d;else break}}function u(a){a=a[0];return void 0===a?null:a}function N(a){var b=a[0];if(void 0!==b){var c=a.pop();if(c!==b){a[0]=c;for(var d=0,e=a.length;d<e;){var h=2*(d+1)-1,n=a[h],g=h+1,f=a[g];if(void 0!==n&&0>M(n,c))void 0!==f&&0>M(f,n)?(a[d]=f,a[g]=c,d=g):(a[d]=n,a[h]=c,d=h);else if(void 0!==f&&0>M(f,c))a[d]=f,a[g]=c,d=g;else break}}return b}return null}function M(a,b){var c=a.sortIndex-b.sortIndex;return 0!==c?c:a.id-b.id}function z(a){if(null!==q){var b=G;G+=
...
b){return y().useEffect(a,b)};f.useImperativeHandle=function(a,b,c){return y().useImperativeHandle(a,b,c)};f.useLayoutEffect=function(a,b){return y().useLayoutEffect(a,b)};f.useMemo=function(a,b){return y().useMemo(a,b)};f.useReducer=function(a,b,c){return y().useReducer(a,b,c)};f.useRef=function(a){return y().useRef(a)};f.useState=function(a){return y().useState(a)};f.version="16.13.1"});
